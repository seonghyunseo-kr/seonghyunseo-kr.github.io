---
layout: post
title: "[LLM] Technical methods for Prompt Engineering and Optimizations"
date: 2026-02-05
tags: [LLM, study]
style: border
color: primary
...
#### Research Questions
> - What is system and user prompt?
  - Zero-shot? Few-shot? 
...
##### References
[1] Google Cloud Post - What is Prompt Engineering? (https://cloud.google.com/discover/what-is-prompt-engineering) 
